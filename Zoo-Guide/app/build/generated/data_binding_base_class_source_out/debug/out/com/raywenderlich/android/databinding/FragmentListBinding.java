...
public final class FragmentListBinding implements ViewBinding {
  ...
  private FragmentListBinding(@NonNull ConstraintLayout rootView, @NonNull RecyclerView allList,
  ...
  public static FragmentListBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.allList;
      RecyclerView allList = rootView.findViewById(id);
      if (allList == null) {
        break missingId;
      }
      ...
      return new FragmentListBinding((ConstraintLayout) rootView, allList, spinner);
    }
